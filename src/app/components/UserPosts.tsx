...
const userPostCardFeedback = cva("user-post-card-feedback flex gap-5");
...
export default function UserPosts({posts, isLoading}: {posts: PostFromServer[], isLoading: boolean}) {
  return (
